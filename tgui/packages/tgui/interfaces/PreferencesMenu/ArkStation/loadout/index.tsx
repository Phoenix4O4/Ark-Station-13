...
const LoadoutPageInner = (props: { loadout_tabs: LoadoutCategory[] }) => {
  ...
  // ARK STATION EDIT ADDITION START: Multiple loadout presets
  ...
  return (
    <Stack fill height="550px">
      <Stack.Item align="center" width="250px" height="100%">
        <Stack vertical fill>
          <Stack.Item
            height="50%" // ARK STATION EDIT: Better loadout pref: ORIGINAL: 60%
          >
...
const LoadoutSelectedSection = (props: {
  ...
  const loadout_list =
    ...
    data.character_preferences.misc.loadout_lists[
      data.character_preferences.misc.loadout_index
    ]; // ARK STATION EDIT: Multiple loadout presets: ORIGINAL: const { loadout_list } = data.character_preferences.misc;
...
const LoadoutPreviewSection = () => {
  ...
  return (
    <Section
      fill
      // ARK STATION EDIT REMOVAL: Better loadout pref
      // title="&nbsp;"
      // buttons={
      //   <Button.Checkbox
      //     align="center"
    ...
    >
      <Stack vertical fill>
        ...
        <Stack.Item align="center">
          <Stack>
            {/* ARK STATION EDIT ADDITION: Better loadout pref */}
            <Stack.Item>
              <Dropdown
