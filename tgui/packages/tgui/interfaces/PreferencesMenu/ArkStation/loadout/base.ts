...
export type LoadoutList = Record<string, Record<typePath, LoadoutListInfo>>; // ARK STATION EDIT: Multiple loadout presets: ORIGINAL: export type LoadoutList = Record<typePath, LoadoutListInfo>;
