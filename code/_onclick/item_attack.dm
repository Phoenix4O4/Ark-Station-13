...
/obj/item/proc/melee_attack_chain(mob/user, atom/target, params)
	...
	// if(user.client && isitem(target)) 															// ARK STATION DELETED
	// 	if(isnull(user.get_inactive_held_item())) 													// ARK STATION DELETED
	// 		SStutorials.suggest_tutorial(user, /datum/tutorial/switch_hands, params2list(params)) 	// ARK STATION DELETED
	// 	else 																						// ARK STATION DELETED
	// 		SStutorials.suggest_tutorial(user, /datum/tutorial/drop, params2list(params)) 			// ARK STATION DELETED
