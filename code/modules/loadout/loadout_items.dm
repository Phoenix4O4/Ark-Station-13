...
/datum/loadout_item/proc/set_item_color(datum/preference_middleware/loadout/manager, mob/user)
	...
	var/list/loadout = manager.get_current_loadout() // ARK STATION EDIT: Multiple loadout presets: ORIGINAL: var/list/loadout = manager.preferences.read_preference(/datum/preference/loadout)
...
/datum/loadout_item/proc/set_slot_greyscale(datum/preference_middleware/loadout/manager, datum/greyscale_modify_menu/open_menu)
	...
	manager.save_current_loadout(loadout) // ARK STATION EDIT: Multiple loadout presets: ORIGINAL: manager.preferences.update_preference(GLOB.preference_entries[/datum/preference/loadout], loadout)
...
/datum/loadout_item/proc/set_name(datum/preference_middleware/loadout/manager, mob/user)
	...
	loadout = manager.get_current_loadout() // ARK STATION EDIT: Multiple loadout presets: ORIGINAL: loadout = manager.preferences.read_preference(/datum/preference/loadout) // Make sure no shenanigans happened
	if(!loadout?[item_path])
		return FALSE
